...
namespace ServerPlugins.Game
{
    public static class Pathfinder
    {
        ...
        private static Vector3 ArrayToPosition(float[] pos, int start = 0)
        {
            return Vector3.Create(pos[start], pos[start + 1] - YOffset, pos[start + 2]);
        }

        private static float[] PositionToArray(Vector3 vec)
        {
        ...
        public static SmoothPath ComputeSmoothPath(NavMeshQuery navQuery, Vector3 start, Vector3 end)
        {
        ...
        public static Vector3 GetClosestPointOnNavMesh(NavMeshQuery navQuery, Vector3 pos)
        {
